...
func (c *loggingFlags) setup(cliApp *cli.App, app *kingpin.Application) {
	...
	app.Flag("file-log-local-tz", "When logging to a file, use local timezone").Hidden().Envar(cliApp.EnvName("BLINKDISK_FILE_LOG_LOCAL_TZ")).BoolVar(&c.fileLogLocalTimezone)
