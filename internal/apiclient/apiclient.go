...
func (c *BlinkDiskAPIClient) Get(ctx context.Context, urlSuffix string, onNotFound error, respPayload interface{}) error {
...
// onto respPayload which must be a pointer to byte slice or JSON-serializable structure.
func (c *BlinkDiskAPIClient) Post(ctx context.Context, urlSuffix string, reqPayload, respPayload interface{}) error {
...
// onto respPayload which must be a pointer to byte slice or JSON-serializable structure.
func (c *BlinkDiskAPIClient) Put(ctx context.Context, urlSuffix string, reqPayload, respPayload interface{}) error {
...
// onto respPayload which must be a pointer to byte slice or JSON-serializable structure.
func (c *BlinkDiskAPIClient) Delete(ctx context.Context, urlSuffix string, onNotFound error, reqPayload, respPayload interface{}) error {
...
func (c *BlinkDiskAPIClient) runRequest(ctx context.Context, method, url string, notFoundError error, reqPayload, respPayload interface{}) error {
