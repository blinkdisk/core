...
const (
	testContainerEnv                      = "BLINKDISK_AZURE_TEST_CONTAINER"
	testStorageAccountEnv                 = "BLINKDISK_AZURE_TEST_STORAGE_ACCOUNT"
	testStorageKeyEnv                     = "BLINKDISK_AZURE_TEST_STORAGE_KEY"
	testStorageSASTokenEnv                = "BLINKDISK_AZURE_TEST_SAS_TOKEN"
	testImmutableContainerEnv             = "BLINKDISK_AZURE_TEST_IMMUTABLE_CONTAINER"
	testImmutableStorageAccountEnv        = "BLINKDISK_AZURE_TEST_IMMUTABLE_STORAGE_ACCOUNT"
	testImmutableStorageKeyEnv            = "BLINKDISK_AZURE_TEST_IMMUTABLE_STORAGE_KEY"
	testStorageTenantIDEnv                = "BLINKDISK_AZURE_TEST_TENANT_ID"
	testStorageClientIDEnv                = "BLINKDISK_AZURE_TEST_CLIENT_ID"
	testStorageClientSecretEnv            = "BLINKDISK_AZURE_TEST_CLIENT_SECRET"
	testStorageClientCertEnv              = "BLINKDISK_AZURE_TEST_CLIENT_CERTIFICATE"
	testAzureFederatedIdentityFilePathEnv = "BLINKDISK_AZURE_FEDERATED_IDENTITY_FILE_PATH"
)
