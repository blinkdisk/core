...
func TestBaseURLToURI(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			baseURL:   "unix+https:///tmp/blinkdisk-test606141450/sock",
			expURI:    "unix:/tmp/blinkdisk-test606141450/sock",
			expErrMsg: "",
		},
		{
			name:      "blinkdisk scheme",
			baseURL:   "blinkdisk://a:0",
			expURI:    "a:0",
			expErrMsg: "",
		},
		{
			name:      "unix http scheme is invalid",
			baseURL:   "unix+http:///tmp/blinkdisk-test606141450/sock",
			expURI:    "",
