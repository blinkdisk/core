...
Running this command is not needed for using BlinkDisk. Instead, most users should rely on periodic repository maintenance. See https://blinkdisk.com/docs/advanced/maintenance/ for more information.
