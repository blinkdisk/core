...
BLINKDISK_BUILD_FLAGS=-ldflags "-s -w -X github.com/blinkdisk/core/repo.BuildVersion=$(BLINKDISK_VERSION_NO_PREFIX) -X github.com/blinkdisk/core/repo.BuildInfo=$(shell git rev-parse HEAD) -X github.com/blinkdisk/core/repo.BuildGitHubRepo=$(GITHUB_REPOSITORY)"
